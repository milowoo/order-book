...
@UtilityClass
public class GlobalStreamingAdapters {
    ...
    public String toSubscriptionId(BitgetChannel globalChannel) {
        return Stream.of(
                globalChannel.getMarketType(),
                globalChannel.getChannelType(),
                globalChannel.getInstrumentId()
        )
                .map(String::valueOf)
                .collect(Collectors.joining("_"));
    }

    // Creates GlobalChannel from arguments
    // Params: args - [ChannelType, MarketType, Instrument / null]
    public BitgetChannel toGlobalChannel(Object... args) {
